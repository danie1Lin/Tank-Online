...
extern "C" IL2CPP_METHOD_ATTR void CanvasRenderer_SetAlpha_m317732912 (CanvasRenderer_t2598313366 * __this, float ___alpha0, const RuntimeMethod* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		Color_t2555686324  L_0 = CanvasRenderer_GetColor_m2699192164(__this, /*hidden argument*/NULL);
		V_0 = L_0;
		float L_1 = ___alpha0;
		(&V_0)->set_a_3(L_1);
		Color_t2555686324  L_2 = V_0;
		CanvasRenderer_SetColor_m3072996306(__this, L_2, /*hidden argument*/NULL);
		return;
	}
}
