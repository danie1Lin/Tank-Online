...
public class SelectRoom : MonoBehaviour
{
    ...
    public OnEnterRoomHandler onEnterRoom;
    ...
    public void addButton(RoomReview roomReview) {
        var Item = new RoomListItem(Instantiate(m_buttonPrefab, RoomScrollList.content),roomReview,onEnterRoom);
...
public class RoomListItem {
    ...
    public AgentRpc agent;
    public event OnEnterRoomHandler onEnterRoom;

    public RoomListItem(GameObject Item,RoomReview review,OnEnterRoomHandler onEnterRoom)
    {
        this.Item = Item;
        this.agent = agent;
